...
namespace Game.Editor
{
    ...
    public class ComponentCollectionInspector : UnityEditor.Editor
    {
        ...
        private IComponentCollector Collector
        {
            get
            {
                if (m_Collector == null)
                {
                    ...
                    Type collectorType = GetType(collectorTypeName, m_Settings.m_EditorAssemblyNames);
        ...
        private ICollectionGenerator Generator
        {
            get
            {
                if (m_Generator == null)
                {
                    ...
                    Type generatorType = GetType(generatorTypeName, m_Settings.m_EditorAssemblyNames);
        ...
        private void InitSerializeData()
        {
            ...
            collectorTypeNames.AddRange(GetTypeNames(typeof(IComponentCollector), m_Settings.m_EditorAssemblyNames));
            ...
            generatorTypeNames.AddRange(GetTypeNames(typeof(ICollectionGenerator), m_Settings.m_EditorAssemblyNames));
        ...
        private void AddBehaviourComponent()
        {
            ...
            Type componentType = GetType(typeName, m_Settings.m_RuntimeAssemblyNames);
            if (componentType == null)
            {
                Debug.LogWarningFormat("Can't load type '{0}'. Please check  whether 'ComponentCollectionInspector.m_RuntimeAssemblyNames' contains the assembly name of this type? ", typeName);
                return;
            }
