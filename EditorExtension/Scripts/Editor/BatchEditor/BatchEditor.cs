...
namespace Game.Editor
{
    public class BatchEditor : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            helperTypeNames.AddRange(EditorType.GetTypeNames(typeof(BatchEditHelperBase)));
        ...
        private void GUISelectHelper()
        {
            ...
            if (helperTypeNameIndex != m_HelperTypeNameIndex)
            {
                ...
                Type helperType = EditorType.GetEditorType(m_HelperTypeNames[m_HelperTypeNameIndex]);
                if (helperType != null)
                {
