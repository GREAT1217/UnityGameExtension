...
// copy from DefaultControls of https://github.com/Unity-Technologies/uGUI.git
namespace GameExtension.Editor
{
    ...
    public static class UGUICreator
    {
        ...
        private static Vector2 s_GroupElementSize = new Vector2(200f, 200f);
        ...
        {
            GameObject panelRoot = CreateUIElementRoot("Panel", s_GroupElementSize);
        ...
        ///     Text
        /// </remarks>
        /// <param name="raycastTarget">Is it as raycast target.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateText(bool raycastTarget)
        {
            ...
            lbl.raycastTarget = raycastTarget;
        ...
        /// <param name="raycastTarget">Is it as raycast target.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateImage(bool raycastTarget)
        {
        ...
        /// <param name="raycastTarget">Is it as raycast target.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateRawImage(bool raycastTarget)
        {
        ...
        /// </remarks>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateRectRaycast()
        {
            GameObject go = CreateUIElementRoot("RectRaycast", s_ImageElementSize);
            go.AddComponent<RectRaycast2D>();
            return go;
        }

        /// <summary>
        /// Create the RectRaycast2D Button.
        /// </summary>
        /// <remarks>
        /// Hierarchy:
        /// (root)
        ...
        /// </remarks>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateRectButton()
        {
            GameObject buttonRoot = CreateUIElementRoot("Button", s_ThickElementSize);

            buttonRoot.AddComponent<RectRaycast2D>();
        ...
        /// </remarks>
        /// <param name="resources">The resources to use for creation.</param>
        /// <param name="useText">Is it use Text to show string.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateButton(Resources resources, bool useText)
        {
            GameObject buttonRoot = CreateUIElementRoot("Button", s_ThickElementSize);
        ...
        /// <param name="useText">Is it use Text to show string.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateToggle(Resources resources, bool useText)
        {
            // Set up hierarchy
            ...
            if (useText)
            {
                ...
                GameObject childLabel = CreateUIObject("Text", toggleRoot);
        ...
        /// </remarks>
        /// <param name="resources">The resources to use for creation.</param>
        /// <param name="useMask">Is it use Mask or RectMask2D.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateScrollView(Resources resources, bool useMask)
        {
            GameObject root = CreateUIElementRoot("ScrollView", s_GroupElementSize);
            ...
            vScrollbar.name = "ScrollbarVertical";
        ...
        /// <param name="useMask">Is it use Mask or RectMask2D.</param>
        /// <returns>The root GameObject of the created element.</returns>
        public static GameObject CreateDropdown(Resources resources, bool useMask)
        {
            ...
            itemCheckmarkImage.raycastTarget = false;
